...
We update the expression set with the contact info:
```{r}
myEset <- ExpressionSet(assayData=myExpress,phenoData=myAnnotDF,fetureNames =myGenes,experimentData = myDesc)
```
